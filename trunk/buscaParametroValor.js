/*
    buscaParametroValor - proyecto
    Esta funcion se encarga de buscar el valor de una variable en base a la posicion que se le pida dentro
    de un conjunto de elementos Variable=valor  
*/
function buscaParametroValor(cadena,parametro,separador,posicion)
{   
   var i;
   var j=0;
   var subc;
