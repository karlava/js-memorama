	...
	if( columnas[0] == "columnas" && filas[0] == "filas" ) {
		...
		/* recorre las columnas */
			...
			for ( i=0; i<columnas[1]; i++ ) {
				...
				for ( j=0; j<filas[1]; j++ ) {
					document.writeln('<td>');
					document.writeln('<img id="carta' + contadorCartas + '" src="carta0.gif" alt="carta" width="72" height="72" onclick="javascript: mostrarCarta(' + contadorCartas + ');"\/>');
					document.writeln('<\/td>');
